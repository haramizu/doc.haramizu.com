...
Sitecore CDP (Customer Data Platform) は、顧客のデータを一元管理し、統合された顧客プロファイルを作成するためのプラットフォームです。これにより、企業は顧客の行動や嗜好を深く理解し、パーソナライズされた体験を提供することができます。
...
- **Guest** : 匿名および認証済ユーザーのプロファイル情報を確認できます
