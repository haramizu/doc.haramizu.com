...
### Sitecore Content Hub <Badge text="New" variant="note" />
...
- [Learn more](/en/ch/connect-for-content-hub/)
...
## Related Technologies <Badge text="Update" variant="note" />

Here, we introduce the following content as related technologies.

- [Next.js](/en/nextjs/overview/) <Badge text="New" variant="success" />
- [Astro](/en/astro/starlight/)
- **Vercel** <Badge text="New" variant="success" />
