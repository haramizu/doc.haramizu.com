...
Sitecore CDP (Customer Data Platform) is a platform for centralized management of customer data and creating integrated customer profiles. This allows companies to deeply understand customer behaviors and preferences and provide personalized experiences.
...
- **Guest**: View profile information of anonymous and authenticated users
...
- **Dashboard**: View reports on access status and profiles accumulated on the site
...
- [Manage a point of sale](https://doc.sitecore.com/cdp/en/users/sitecore-cdp/manage-a-point-of-sale.html)
- [Introduction to Sitecore Personalize](https://doc.sitecore.com/personalize/en/users/sitecore-personalize/introduction-to-sitecore-personalize.html)
- [Manage a point of sale in Sitecore Personalize](https://doc.sitecore.com/personalize/en/users/sitecore-personalize/manage-a-point-of-sale-in-sitecore-personalize.html)